...
function list_content(childdata,k,all_keys,search_key_length,n,i){
    ...
    if(header_trim(suggesttype)!="" && suggesttype == 1){
        ...
        listhtml = '<div class="select_pop" id="keyword_'+b+'" style="display:none;"><p class="name"><a href="javascript:void(0);" title="'+data3+'"  '+click_event+'>'+data3+'</a></p><a class="pics" href="javascript:void(0);" title="'+data3+'" '+click_event+'><img src="'+data5+'"></a>'+listcontent+'</div>';
    }
    if(header_trim(suggesttype)!="" && suggesttype == 2){
        ...
        listhtml = '<div class="select_pop" id="keyword_'+b+'" style="display:none;"><p class="name"><a href="javascript:void(0);" title="'+data3+'" '+click_event+'>'+data3+'</a></p><a class="pics" href="javascript:void(0);" title="'+data3+'" '+click_event+'><img src="'+data9+'"></a>'+listcontent+'</div>';
    }
